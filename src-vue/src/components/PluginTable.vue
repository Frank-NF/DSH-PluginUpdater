        ...
        >
          <div class="weui-media-box weui-media-box_appmsg">
            <div class="weui-media-box__hd">
              <span
                class="w-plugin-icon"
                :class="{ 'is-update': row.update_available }"
              >
                <WIcon name="plugin" :size="20" />
              </span>
            </div>
            <div class="weui-media-box__bd">
              <h4 class="weui-media-box__title">
...
type TabName = 'market' | 'bundles' | 'installed'
...
const updatableNpmKeys = computed(() => {
  ...
  for (const p of props.plugins.filter(isUpdatable)) {
